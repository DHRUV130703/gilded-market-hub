        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              The world's premier destination for authentic luxury goods. 
              Curated collections from the most prestigious brands worldwide.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <Mail className="h-4 w-4 text-amber-400 mr-3" />
                <span className="text-gray-400">concierge@luxuria.com</span>
              </div>
              <div className="flex items-start">
                <MapPin className="h-4 w-4 text-amber-400 mr-3 mt-1" />
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-2 focus:ring-amber-500 text-white"
                />
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Luxuria. All rights reserved. Authentic luxury guaranteed.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Privacy Policy</a>
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Terms of Service</a>
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Authenticity Guarantee</a>
            </div>
          </div>
        </div>
      </div>
